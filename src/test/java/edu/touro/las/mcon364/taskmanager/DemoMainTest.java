...
class DemoMainTest {
    ...
    void testDemonstrateAddingTasks() {
        ...
        var dependencies = testRegistry.get("Update dependencies");
        ...
        var bug = testRegistry.get("Fix critical bug");
        ...
        var refactor = testRegistry.get("Refactor code");
    ...
    @Test
    @DisplayName("Retrieving non-existent task should throw an error")
    void testDemonstrateRetrievingNonExistentTask() {
        TaskRegistry testRegistry = new TaskRegistry();

        assertThrows(TaskNotFoundException.class, ()->testRegistry.get("Non-existent task"));
    ...
    void testDemonstrateUpdatingTask() {
        ...
        var before = testRegistry.get("Refactor code");
        ...
        var after = testRegistry.get("Refactor code");
    ...
    void testDemonstrateRemovingTask() {
        ...
        assertThrows(TaskNotFoundException.class, () -> testRegistry.get("Update dependencies"), "Update dependencies should be removed");
    ...
    void testDemonstrateNullReturn() {
        ...
        assertThrows(TaskNotFoundException.class, () ->testRegistry.get("Non-existent task"), "Getting non-existent task should return null (before Optional refactoring)");
    }
    ...
    void testAddTaskCommand() {
        ...
        command.execute();
        Optional<Task> result = testRegistry.get("Test task");
        assertNotNull(testRegistry.get("Test task"), "Task should be added after command execution");
        assertEquals(task, result.get(), "Added task should match original");
    }
    ...
    void testRemoveTaskCommand() {
        ...
        assertThrows(TaskNotFoundException.class, () ->testRegistry.get("Test task"), "Task should be removed after command execution");
    }
    ...
    void testUpdateTaskCommand() {
        ...
        var updated = testRegistry.get("Test task");
    ...
    void testTaskManagerRunWithRemoveCommand() {
        ...
        assertThrows(TaskNotFoundException.class, () ->testRegistry.get("Test task"), "Task should be removed via TaskManager.run()");
    }
